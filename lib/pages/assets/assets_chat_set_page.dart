...
class AssetsChatSetPage extends StatefulWidget {
  const AssetsChatSetPage({super.key});

  @override
  State<AssetsChatSetPage> createState() => _AssetsChatSetPageState();
}

class _AssetsChatSetPageState extends State<AssetsChatSetPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ABAppBar(
        ...
        backIconCenter: true,
        title: AB_getS(context).chatSettings,
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _getSwitchRowWidget(
                title: AB_getS(context).autoAcceptGroup,
                value: provider.chatSetting.autoAccept??false,
                onSwitchChange: (value) {
                  provider.chatSetting = provider.chatSetting.copyWith(autoAccept: value);
                }),
            _getSwitchRowWidget(
                title: AB_getS(context).exitingDelete,
                value: provider.chatSetting.exitDelete??false,
                onSwitchChange: (value) {
                  provider.chatSetting = provider.chatSetting.copyWith(exitDelete: value);
                }),
          ],
        ),
      ),
