...
class AssetsRecordPage extends StatefulWidget {
  final int? index;
  const AssetsRecordPage({super.key, this.index});

  @override
  State<AssetsRecordPage> createState() => _AssetsRecordPageState();
}

class _AssetsRecordPageState extends State<AssetsRecordPage>
  ...
  @override
  void dispose() {
    // ABRoute.pageHistory.remove(AssetsRecordPage().routerName());
    super.dispose();
  }
        ...
        children: [
                      ...
                      SizedBox(
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            ...
                            Tab(text: AB_getS(context).activityRecord),
                          ],
                        ),
                      ),
                    ],
          ...
          Expanded(
              child: TabBarView(
                controller: controller,
                children: const [
                  AssetsRechargeRecordView(),
                  AssetsWithdrawalRecordView(),
                  AssetsTransferRecordView(),
                  AsstesRecordActivityView(),
                ],
              )
          ),
        ],
