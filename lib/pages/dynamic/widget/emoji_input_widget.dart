...
class EmojiInputWidget extends StatefulWidget {
  //自定义
  //顶部背景
  ...
  @override
  State<EmojiInputWidget> createState() => _EmojiInputWidgetState();
}

class _EmojiInputWidgetState extends State<EmojiInputWidget> {
  ...
  void initState() {
    ...
    stickerPackageList.add(CustomStickerPackage(
        ...
        isDefaultEmoji: true,
        stickerList:
            tccEmojiSet.list.asMap().keys.map((idx) => CustomSticker(index: idx, name: tccEmojiSet.list[idx])).toList(),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      // height: 200.0,
      child: TIMUIKitTextFieldLayoutNarrow(
        onChanged: (value) {
        ...
        onCustomEmojiFaceSubmitted: (index, value) {},
        backSpaceText: () {
          // 删除x按钮
        },
        ...
        handleSendEditStatus: (value, ist) {},
        handleAtText: (text) {
          //键盘输入
        },
        handleSoftKeyBoardDelete: () {},
        onSubmitted: () {},
        goDownBottom: () {
          //表情展开收缩&键盘
          widget.goDownBottom == null ? null : widget.goDownBottom!();
        },
        showSendAudio: false,
        showSendEmoji: true,
        showMorePanel: false,
        ...
        weakBackgroundColor: theme.backgroundColor,
        hintText: widget.hintText,
        scrollDirection: widget.scrollDirection,
        isShowSend: widget.isShowSend,
        showBottomContainer: widget.showBottomContainer,
        showDeleteButton: widget.showDeleteButton,
        childCenter: widget.childCenter,
        padding: widget.padding,
        inputHeight: widget.inputHeight,
        showRecentEmo: widget.showRecentEmo,
        recentEmoText: widget.recentEmoText,
        allEmoText: widget.allEmoText,
      ),
    );
  }
