...
class DynamicSelectUserPage extends StatefulWidget {
  const DynamicSelectUserPage({super.key});

  @override
  State<DynamicSelectUserPage> createState() => _DynamicSelectUserPageState();
}

class _DynamicSelectUserPageState extends State<DynamicSelectUserPage> {
  String _searchText = "";
