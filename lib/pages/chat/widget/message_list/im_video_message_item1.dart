...
class ImVideoMessageItem1 extends StatefulWidget {
  ...
  const ImVideoMessageItem1(this.message,
      {Key? key,
  ...
  @override
  State<StatefulWidget> createState() => _ImVideoMessageItem1State();
}

class _ImVideoMessageItem1State extends TIMUIKitState<ImVideoMessageItem1> {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return ImBubbleWidget(isFromSelf: widget.message.isSelf ?? true, child: GestureDetector(
      onTap: () {
        if (PlatformUtils().isWeb) {
