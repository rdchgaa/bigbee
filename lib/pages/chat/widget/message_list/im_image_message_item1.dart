...
class ImImageMessageItem1 extends StatefulWidget {
...
class _TIMUIKitImageElem extends TIMUIKitState<ImImageMessageItem1> {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return ImBubbleWidget(isFromSelf: widget.message.isSelf ?? true,
