...
import 'widget/group_member_list_item.dart';
...
class GroupMemberListPage extends StatefulWidget {
  ...
  const GroupMemberListPage(
      {super.key, required this.groupID, required this.memberCount, this.isManager = false});
...
class _GroupMemberListPageState extends State<GroupMemberListPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ABAppBar(
        title: "${AB_getS(context).groupMember}(${widget.memberCount})",
