...
class DialogAlertYearBox extends StatefulWidget {
  ...
  const DialogAlertYearBox({
    ...
    this.buttonOk,
    this.buttonCancel,
    required this.contentAlign, this.contentWidget, required this.list,
  }) : super(key: key);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ABText(item.toString(), fontSize: 16.px,textColor: theme.textColor,),
                ],
              ),
