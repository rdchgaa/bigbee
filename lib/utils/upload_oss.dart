...
class UploadOss {
  ...
  // oss设置的bucket的名字
  static String bucket = 'beechats';
  // 发送请求的url,根据你自己设置的是哪个城市的
  static String url = 'https://$bucket.oss-cn-beijing.aliyuncs.com';
  ...
  static Future<String?> upload({ required File file , String rootDir = 'moment', String? fileType, Function? callback, Function? onSendProgress}) async {
    ...
    print("policyText - ${getSplicyBase64(policyText)}");
    // 获取签名
