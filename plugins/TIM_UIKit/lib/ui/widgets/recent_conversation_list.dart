...
class _RecentForwardListState extends TIMUIKitState<RecentForwardList> {
  ...
  List<ISuspensionBeanImpl<V2TimConversation?>> _buildMemberList(
    ...
    for (var i = 0; i < conversationList.length; i++) {
      ...
      if (item?.userID != "10124410" && item?.userID != "10124400") {
  ...
  Widget _buildItem(V2TimConversation conversation, TUITheme theme) {
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        height: isDesktopScreen ? 30 : 50,
                        width: isDesktopScreen ? 30 : 50,
                      ...
                      Expanded(
                        ...
                        child: Text(
                          ...
                          style:
                          TextStyle(color: theme.textColor, fontSize: isDesktopScreen ? 16 : 16, fontWeight: FontWeight.w600),
                        ),
                      ))
                    ],
                  ),
        ...
        return AZListViewContainer(
          ...
          itemBuilder: (context, index) {
            ...
            if (conversation != null) {
              return _buildItem(conversation, theme);
            } else {
              return Container();
            }
          },
