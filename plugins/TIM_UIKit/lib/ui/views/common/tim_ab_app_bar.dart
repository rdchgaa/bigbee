...
class TimAbAppBar extends StatelessWidget implements PreferredSizeWidget, ObstructingPreferredSizeWidget {
  const TimAbAppBar({
    super.key,
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Stack(
                    children: [
                      (customTitle != null) ? Center(child: customTitle!,) : Center(
                        child: Container(
