...
class AssetPickerResultData{
  final List<AssetEntity> assets;
  final bool isNativeImage;
  final bool isMinxImage;
  AssetPickerResultData({required this.assets,required this.isNativeImage, required this.isMinxImage,});
}
...
class AssetPicker<Asset, Path> extends StatefulWidget {
  ...
  static Future<AssetPickerResultData?> pickAssets(
