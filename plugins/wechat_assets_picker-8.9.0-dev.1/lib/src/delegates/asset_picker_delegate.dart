...
class AssetPickerDelegate {
  ...
  /// {@endtemplate}
  Future<AssetPickerResultData?> pickAssets(
    BuildContext context, {
    Key? key,
    AssetPickerConfig pickerConfig = const AssetPickerConfig(),
    bool useRootNavigator = true,
    AssetPickerPageRouteBuilder<AssetPickerResultData>? pageRouteBuilder,
  }) async {
    final PermissionState ps = await permissionCheck();
    final AssetPickerPageRoute<AssetPickerResultData> route =
        pageRouteBuilder?.call(const SizedBox.shrink()) ??
            AssetPickerPageRoute<AssetPickerResultData>(
    ...
    final DefaultAssetPickerProvider provider = DefaultAssetPickerProvider(
      ...
      initializeDelayDuration: route.transitionDuration,
        showMergeSend:pickerConfig.showMergeSend,
      showOriginalBtn: pickerConfig.showOriginalBtn,
      isDynamic:pickerConfig.isDynamic,
    ...
    final AssetPickerResultData? result = await Navigator.of(
      context,
      rootNavigator: useRootNavigator,
    ).push<AssetPickerResultData>(
      pageRouteBuilder?.call(picker) ??
          AssetPickerPageRoute<AssetPickerResultData>(builder: (_) => picker),
    );
    return result;
  }
