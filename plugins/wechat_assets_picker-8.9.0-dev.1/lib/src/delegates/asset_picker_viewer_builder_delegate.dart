...
class DefaultAssetPickerViewerBuilderDelegate
  ...
  Widget bottomDetailBuilder(BuildContext context) {
    ...
    return ValueListenableBuilder2<bool, int>(
      ...
      builder: (_, bool v, __, Widget? child) => AnimatedPositionedDirectional(
        ...
        height: context.bottomPadding + bottomDetailHeight+bottomPreviewHeight + 30,
        child: child!,
      ),
      child: CNP<AssetPickerViewerProvider<AssetEntity>?>.value(
        ...
        child: Column(
          ...
          children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        child: Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                textDelegate.selectTip.replaceAll('\${num}',
                                    selectorProvider!.selectedAssets.length.toString()).replaceAll('\${numMax}', selectorProvider!.maxAssets.toString()),
                                style: TextStyle(
                                    fontSize: 14, color: Color(0xff989897)),
                              ),
                            )),
                      ),
                      Expanded(
            ...
            SizedBox(height: appBarItemHeight+20+10,)
            // Container(
            //   height: appBarItemHeight+20,
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: !isButtonEnabled?[themeData.dividerColor,themeData.dividerColor]:[
                    Color(0xffFFCB32),
                    Color(0xffFB8701),
                  ],
  ...
  Widget _androidSelectButton(
    ...
    return Checkbox(
      value: isSelected,
      fillColor: isSelected?WidgetStateProperty.all(Color(0xffFFCB32)):WidgetStateProperty.all(Color(0xffffffff)),
