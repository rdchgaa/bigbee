...
import 'package:wechat_assets_picker/src/delegates/my_picker.dart';
    ...
    return Row(
      ...
      children: [
        InkWell(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: 19, right: 19, top: 5, bottom: 5),
            child: Text(
              textDelegate.image,
              style: TextStyle(
                  color: pickerTheme?.textTheme.titleMedium?.color,
                  fontSize: provider.selectType == 1 ? 18 : 16,
                  fontWeight:
                      provider.selectType == 1 ? FontWeight.w600 : null),
            ),
          ),
        ),
        InkWell(
          ...
          child: Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: pickerTheme?.textTheme.titleMedium?.color,
                  fontSize: provider.selectType == 2 ? 18 : 16,
                  fontWeight:
                      provider.selectType == 2 ? FontWeight.w600 : null),
            ),
          ),
        ),
        InkWell(
          ...
          child: Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: pickerTheme?.textTheme.titleMedium?.color,
                  fontSize: provider.selectType == 3 ? 18 : 16,
                  fontWeight:
                      provider.selectType == 3 ? FontWeight.w600 : null),
            ),
          ),
        )
      ],
          ...
          builder: (BuildContext context, _) => Material(
            ...
            child: Stack(
              ...
              children: <Widget>[
                MyPicker(
                  theme: theme,
                  shouldBuildSpecialItem: shouldBuildSpecialItem,
                  switchingPathDuration: switchingPathDuration,
                  provider: provider,
                  loadingIndicatorBuilder: loadingIndicatorBuilder,
                  textDelegate: textDelegate,
                  semanticsTextDelegate: semanticsTextDelegate,
