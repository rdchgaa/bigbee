...
//        containerView.backgroundColor = .clear//UIColor(red: 249 / 255, green: 246 / 255, blue: 244 / 255, alpha: 1)
...
//            make.height.equalTo(1.scaleWidth())
//        }
//        
//        videoImageView.snp.makeConstraints { make in
//            make.centerY.equalToSuperview()
//            make.leading.equalToSuperview().offset(14.scaleWidth())
//            make.width.height.equalTo(0.scaleWidth())
//        }
//        
...
//        }
        ...
        dialingImageView.snp.makeConstraints { make in
            ...
            make.top.equalToSuperview().offset(22.scaleWidth())
...
//            make.centerX.equalToSuperview()
//            make.top.equalToSuperview().offset(70.scaleWidth())
...
//        }
    ...
    func updateTimerCountUI() {
        print("多语言显示 - \(TUICallState.instance.mResourceDic)")
        if viewModel.selfCallStatus.value == .waiting {
