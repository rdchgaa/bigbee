...
class TUICallKit {
  ...
  Future<void> setChooseGroupMemberListFunction(Future<List<String>> Function(String groupId, List<String> selectedMemberIds, List<String> excludeMemberIds, int? maxNum)? chooseGroupMemberList) async {
    return await CallManager.instance.setChooseGroupMemberListFunction(chooseGroupMemberList);
  }
