...
// gif图片首帧
  ...
  Widget build(BuildContext context) {
    ...
    Widget? img;
    if (isImgFromNetwork) {
      final url1 = url.startsWith("https://beechats.oss-cn-beijing.aliyuncs.com") ? "${url}?x-oss-process=image/resize,h_120,m_lfit" : "";
      // print("url1: $url1");
      img = CachedNetworkImage(
        imageUrl: url1,//"https://beechats.oss-cn-beijing.aliyuncs.com/2024/9/27/99eabe87-379c-4324-8e02-3f7b2320471e.gif",
        height: size,
        width: size,
      );
    }
